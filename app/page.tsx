      ...
      <div className="bg-white py-24 sm:py-32 rounded-md drop-shadow-xl">
        <div className="flex flex-col justify-center items-center mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl sm:text-center">
            <h2 className="text-transform: capitalize text-base font-semibold leading-7 text-indigo-600">Your interative Document companian</h2>
            <p className="text-transform: capitalize mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-6xl">transform your pdf into interative conversations</p>
            <p className="mt-6 text-lg leading-8 text-gray-600">
              Introducing{" "}
              <span className="font-bold text-indigo-600 text-transform: capitalize">chat with pdf</span>
              <br/>
